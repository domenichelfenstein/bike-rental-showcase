export function setCookie(key: string, value: string | undefined, hours : number | undefined = undefined) {
...
export function getCookie(queryKey: string) : string | undefined {
